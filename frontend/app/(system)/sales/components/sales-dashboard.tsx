  ...
  const resolvedPieces: SalePieceOption[] =
    workspace?.pecasDisponiveis && workspace.pecasDisponiveis.length > 0
      ...
      : (fallbackPiecesQuery.data ?? []).map((piece) => ({
          ...
          precoBase: piece.precoBase,
          precoVendaAtual: piece.precoEfetivoVenda,
          percentualDescontoAutomatico: piece.percentualDescontoAutomatico,
          descontoAutomaticoAtivo: piece.descontoAutomaticoAtivo,
