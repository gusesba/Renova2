    ...
    <div className="space-y-5">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <button
          ...
          aria-label="Configurar tabela de pecas"
        >
          <GearIcon />
        </button>
      </div>
          ...
          <div className={isExpanded ? "overflow-visible" : "overflow-hidden"}>
            ...
            >
              ...
              <SelectField
                ...
                onChange={(ordenarPor) =>
                  onChange({ ordenarPor: ordenarPor as ClientAreaFilters["ordenarPor"] })
                }
              />
              <SelectField
                label="Direcao"
                ...
                onChange={(direcao) =>
                  onChange({ direcao: direcao as ClientAreaFilters["direcao"] })
                }
              />
            </div>
          </div>
