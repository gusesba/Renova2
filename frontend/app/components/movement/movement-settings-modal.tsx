...
import type { MovementTableSettings, MovementVisibleField } from "@/lib/movement";

type MovementSettingsModalProps = {
  isOpen: boolean;
  settings: MovementTableSettings;
  onClose: () => void;
  onSave: (settings: MovementTableSettings) => void;
};

const fieldOptions: Array<{ description: string; label: string; value: MovementVisibleField }> = [
  { label: "Identificador", value: "id", description: "Codigo interno da movimentacao" },
  { label: "Data", value: "data", description: "Data registrada na movimentacao" },
...
export function MovementSettingsModal({
  ...
  onClose,
  onSave,
}: MovementSettingsModalProps) {
  const [shouldRender, setShouldRender] = useState(isOpen);
  const [isVisible, setIsVisible] = useState(false);
  const [draft, setDraft] = useState<MovementTableSettings>(settings);
