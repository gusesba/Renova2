...
import type { ProductTableSettings, ProductVisibleField } from "@/lib/product";

type ProductSettingsModalProps = {
  isOpen: boolean;
  settings: ProductTableSettings;
  onClose: () => void;
  onSave: (settings: ProductTableSettings) => void;
};
...
export function ProductSettingsModal({
  ...
  const [draft, setDraft] = useState<ProductTableSettings>(settings);
