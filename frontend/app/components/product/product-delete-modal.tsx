    ...
    >
      ...
      >
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-7 text-[var(--muted)]">
                {productName
                  ? `Voce esta prestes a excluir o produto #${productName}. Essa acao nao pode ser desfeita.`
                  : "Voce esta prestes a excluir este produto. Essa acao nao pode ser desfeita."}
              </p>
            </div>
          </div>
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-end">
          ...
          >
            {isSubmitting ? "Excluindo produto..." : "Confirmar exclusao"}
          </button>
        </div>
      </div>
    </div>
