...
import type {
  ClientDetailProductTableSettings,
  ClientDetailProductVisibleField,
} from "@/lib/client";

type ClientDetailProductSettingsModalProps = {
  isOpen: boolean;
  settings: ClientDetailProductTableSettings;
  title: string;
  onClose: () => void;
  onSave: (settings: ClientDetailProductTableSettings) => void;
};

const fieldOptions: Array<{
  description: string;
  label: string;
  value: ClientDetailProductVisibleField;
}> = [
  { label: "ID Produto", value: "id", description: "Identificador interno do produto" },
...
export function ClientDetailProductSettingsModal({
  isOpen,
  settings,
  title,
  onClose,
  onSave,
}: ClientDetailProductSettingsModalProps) {
  const [shouldRender, setShouldRender] = useState(isOpen);
  const [isVisible, setIsVisible] = useState(false);
  const [draft, setDraft] = useState<ClientDetailProductTableSettings>(settings);
