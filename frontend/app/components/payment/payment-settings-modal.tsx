...
import type { PaymentTableSettings, PaymentVisibleField } from "@/lib/payment";

type PaymentSettingsModalProps = {
  isOpen: boolean;
  settings: PaymentTableSettings;
  onClose: () => void;
  onSave: (settings: PaymentTableSettings) => void;
};

const fieldOptions: Array<{ description: string; label: string; value: PaymentVisibleField }> = [
...
export function PaymentSettingsModal({
  ...
  const [draft, setDraft] = useState<PaymentTableSettings>(settings);
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm leading-7 text-[var(--muted)]">
              Defina quantos pagamentos aparecem por pagina e quais colunas ficam visiveis.
            </p>
          </div>
