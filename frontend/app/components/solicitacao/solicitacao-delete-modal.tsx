...
type SolicitacaoDeleteModalProps = {
...
export function SolicitacaoDeleteModal({
  description,
  isOpen,
  isSubmitting,
  onClose,
  onConfirm,
}: SolicitacaoDeleteModalProps) {
    ...
    >
      ...
      >
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-7 text-[var(--muted)]">
                {description
                  ? `Voce esta prestes a excluir a solicitacao ${description}. Essa acao nao pode ser desfeita.`
                  : "Voce esta prestes a excluir esta solicitacao. Essa acao nao pode ser desfeita."}
              </p>
            </div>
          </div>
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-end">
          ...
          >
            {isSubmitting ? "Excluindo solicitacao..." : "Confirmar exclusao"}
          </button>
        </div>
      </div>
    </div>
