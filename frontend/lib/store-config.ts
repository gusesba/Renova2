...
export type ConfigLojaResponse = {
  ...
  formasPagamento: ConfigLojaFormaPagamentoResponse[];
};
...
export type StorePaymentMethodFormValue = {
  id: string;
  nome: string;
...
export const initialStorePaymentMethodValues: StorePaymentMethodFormValue[] = [];
