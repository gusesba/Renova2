...
namespace Renova.Service.Services.Produto
{
    public interface IProdutoService
    {
        ...
        Task<IReadOnlyList<ProdutoBuscaDto>> GetPendentesDevolucaoDoClienteAsync(ObterProdutosEmprestadosClienteParametros parametros, CancellationToken cancellationToken = default);
