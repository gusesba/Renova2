...
namespace Renova.Persistence.Migrations
{
    ...
    [Migration("20260513122306_LiberacaoUsuario")]
    partial class LiberacaoUsuario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Renova.Domain.Model.FuncionalidadeModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 48,
                            Chave = "solicitacoes.excluir",
                            Descricao = "Excluir solicitacoes da loja.",
                            Grupo = "Solicitacoes"
                        });
                });
            ...
            modelBuilder.Entity("Renova.Domain.Model.LiberacaoUsuarioModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime>("LiberadoAte")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("LiberacaoUsuario", (string)null);
                });
            ...
            modelBuilder.Entity("Renova.Domain.Model.MovimentacaoModel", b =>
                {
                    ...
                    b.HasIndex("LojaId", "ClienteId", "Tipo", "Data");
            ...
            modelBuilder.Entity("Renova.Domain.Model.ProdutoEstoqueModel", b =>
                {
                    ...
                    b.HasIndex("LojaId", "Etiqueta")
                        .IsUnique();

                    b.HasIndex("LojaId", "Situacao");

                    b.HasIndex("LojaId", "FornecedorId", "Entrada");
